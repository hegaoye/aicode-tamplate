...
import ${basePackage}.core.hutool.convert.impl.CollectionConverter;
import ${basePackage}.core.hutool.util.CharsetUtil;
import ${basePackage}.core.hutool.util.HexUtil;
...
public final class Convert {
     ...
     * @return 转换后的结果
     */
    public static String toChineseStr(Integer number) {
        String[] hanArr = {"零", "一", "二", "三", "四", "五", "六", "七",
                "八", "九"};
        String[] unitArr = {"十", "百", "千", "万", "十", "白", "千", "亿",
                "十", "百", "千"};
