package ${basePackage}.core.hutool.util;

import ${basePackage}.core.hutool.convert.BasicType;
import ${basePackage}.core.hutool.exceptions.UtilException;
import ${basePackage}.core.hutool.io.IORuntimeException;
import ${basePackage}.core.hutool.io.resource.ResourceUtil;
import ${basePackage}.core.hutool.lang.ClassScaner;
import ${basePackage}.core.hutool.lang.Filter;
import ${basePackage}.core.hutool.lang.Singleton;
...
public class ClassUtil {
     ...
     *
     * <pre>
     * isSimple为false: "${basePackage}.core.hutool.util.ClassUtil"
     ...
     *                               例如：${basePackage}.core.hutool.StrUtil.isEmpty 或 ${basePackage}.core.hutool.StrUtil#isEmpty
     ...
     *
     * @param <T>                     对象类型
     * @param classNameWithMethodName 类名和方法名表达式，例如：${basePackage}.core.hutool.StrUtil#isEmpty或${basePackage}.core.hutool.StrUtil.isEmpty
     ...
     * 获得给定类所在包的名称<br>
     * 例如：<br>
     * ${basePackage}.core.hutool.util.ClassUtil =》 ${basePackage}.core.hutool.util
     *
     * @param clazz 类
     * @return 包名
     */
