...
import ${basePackage}.core.hutool.date.format.FastDateFormat;
...
public class DatePattern {
     ...
     * 标准日期格式：yyyy-MM
     */
    public final static String NOR_DATE_PATTERN = "yyyy-MM";
    /**
     * 标准日期格式 {@link FastDateFormat}：yyyy-MM
     */
    public final static FastDateFormat NOR_DATE_FORMAT = FastDateFormat.getInstance(NOR_DATE_PATTERN);
