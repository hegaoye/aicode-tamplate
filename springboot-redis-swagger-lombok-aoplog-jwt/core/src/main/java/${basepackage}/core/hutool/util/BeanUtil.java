...
import ${basePackage}.core.hutool.bean.BeanInfoCache;
import ${basePackage}.core.hutool.bean.BeanResolver;
import ${basePackage}.core.hutool.bean.DynaBean;
import ${basePackage}.core.hutool.collection.CaseInsensitiveMap;
