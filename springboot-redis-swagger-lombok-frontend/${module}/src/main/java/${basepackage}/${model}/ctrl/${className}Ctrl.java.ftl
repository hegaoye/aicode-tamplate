...
public class ${className}Ctrl {
    ...
    */
    ...
    <#list pkFields as pkField>
        ...
        ${className} ${classNameLower} = ${classNameLower}SV.get(<#list pkFields as pkField>${pkField.field}<#if pkField_has_next>,</#if></#list>);
        log.info(JSON.toJSONString(${classNameLower}));
        return BeanRet.create(true, BaseException.BaseExceptionEnum.Success, ${classNameLower});
    }
   </#if>
   ...
   */
   ...
   public BeanRet getBy${pkField.field?cap_first}(@PathVariable ${pkField.fieldType} ${pkField.field}) {
       ...
       ${className} ${classNameLower} = ${classNameLower}SV.getBy${pkField.field?cap_first}(${pkField.field});
       log.info(JSON.toJSONString(${classNameLower}));
       return BeanRet.create(true, BaseException.BaseExceptionEnum.Success, ${classNameLower});
   }
   </#list>
    ...
    */
    ...
    public BeanRet list(@ApiIgnore ${className} ${classNameLower},@ApiIgnore Page<${className}> page) {
        ...
        List<${className}> ${classNameLower}s = ${classNameLower}SV.list(${classNameLower},page.getCurPage(),page.getPageSize());
    ...
    */
    ...
    public BeanRet listByPk(<#list pkFields as pkField>${pkField.fieldType} ${pkField.field},</#list>@ApiIgnore Page<${className}> page) {
        ...
        List<${className}> ${classNameLower}s = ${classNameLower}SV.list(<#list pkFields as pkField>${pkField.field},</#list> page.getCurPage(),page.getPageSize());
