...
/** 分页排序工具类 Created by lixin on 2017/6/5. */
public class SortTools implements Serializable {
   ...
   * @param property
   * @param direction
   * @param orderExpr placeholder is "?", in oracle like: "nlssort( ?
   *     ,'NLS_SORT=SCHINESE_PINYIN_M')". Warning: you must prevent orderExpr SQL injection.
   * @return
   */
  public static SortTools create(String property, String direction, String orderExpr) {
    return new SortTools(property, Direction.fromString(direction), orderExpr);
  }
