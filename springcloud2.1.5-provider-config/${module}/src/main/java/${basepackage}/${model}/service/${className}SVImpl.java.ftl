...
import ${basePackage}.${model}.feignclient.${className}FeignApi;
...
public class ${className}SVImpl extends BaseSVImpl<${className}, Long> implements ${className}SV {
  ...
  @Autowired private ${className}DAO ${classNameLower}DAO;

  @Resource private UidGenerator uidGenerator;

  @Autowired private ${className}FeignApi ${classNameLower}FeignApi;
